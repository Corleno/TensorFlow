...
# Step 3: Function to generate a training batch for the skip-gram model.reversed_dictionary
def generate_batch(batch_size, num_skips, skip_window):
	...
	span = 2* skip_window + 1 # [skip_window target skip window]
...
# Step 4: Build and train a skip-gram model.reversed_dictionary
